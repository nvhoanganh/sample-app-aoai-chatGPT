...
const sampleProfileClaims = [
	{
		user_claims: [
			{ typ: 'name', val: 'Anthony Nguyen' },
			{ typ: 'ageGroup', val: '3' },
		],
	},
];

const extractUserProfile = (claims: any[]) => {
	return claims.reduce((pre, curr) => {
		return {
			...pre,
			[curr.typ]: curr.val,
		};
...
const Chat = () => {
	...
	console.log('🚀 ~ file: Chat.tsx:96 ~ Chat ~ userProfile:', userProfile);
			...
			{showAuthMessage ? (
				<Stack className={styles.chatEmptyState}>
					...
					<h2 className={styles.chatEmptyStateSubtitle}>
						...
						add an identity provider by finding your app in the
					...
					>
						<strong>
							Authentication configuration takes a few minutes to
							apply.{' '}
						</strong>
					</h2>
					<h2
					...
					>
						<strong>
							If you deployed in the last 10 minutes, please wait
							and reload the page after 10 minutes.
						</strong>
					</h2>
				</Stack>
			) : (
					...
					<div className={styles.chatContainer}>
						{!messages || messages.length < 1 ? (
							<Stack className={styles.chatEmptyState}>
								...
								<h2 className={styles.chatEmptyStateSubtitle}>
									Need a little help? You’ve come to the right
									place - over 150 years of lessons learnt and
