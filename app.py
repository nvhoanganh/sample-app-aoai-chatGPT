...
AZURE_OPENAI_SYSTEM_MESSAGE = os.environ.get("AZURE_OPENAI_SYSTEM_MESSAGE", "You are an AI assistant that helps police officer working for the Queensland Police Service find information about our process etc. from a lot of documents you have access to. Please respond to me factually and where possible, use dot points or 'steps'")
